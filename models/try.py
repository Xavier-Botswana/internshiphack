...
df = pd.read_csv("")#reading the dataset that is going to be used by the model
print(df.info())
...
df.replace(to_replace ="good", 
                            value =1) 
include = ['Age', 'Sex', 'Job', 'interests','kyc','competencies','qualifications','Duration','experiencece','period'] # selection of features
df_ = df[include]
categoricals = []
